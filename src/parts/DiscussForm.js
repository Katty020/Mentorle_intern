    ...
    <section className="flex flex-col container mx-auto mt-10 justify-center">
      ...
      <Fade direction="up" triggerOnce>
        <div className="flex flex-col">
          ...
          <Button
            className="text-xl mx-auto px-12 py-3 mt-5 bg-theme-purple text-white rounded-full border-2 hover:bg-dark-theme-purple border-purple-800 transition duration-200 focus:outline-none"
            type="button"
            onClick={submitEmail}
          >
            Submit
